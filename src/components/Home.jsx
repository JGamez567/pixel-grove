    ...
    <div className="relative min-h-screen bg-gray-950 overflow-x-hidden">
      ...
      <div className="relative" style={{ zIndex: 1 }}>
        ...
        <section className="flex flex-col items-center text-center px-4 md:px-8 pt-28 pb-16">
          <div className="mb-6 px-4 py-1.5 rounded-full border text-xs font-bold tracking-widest uppercase"
            style={{ ...fadeIn(0), borderColor: 'rgba(74,222,128,0.3)', color: 'rgb(134,239,172)', background: 'rgba(74,222,128,0.05)' }}>
            ✨ Roblox & Adopt Me Store
          </div>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight" style={fadeIn(0.1)}>
            Get Your Dream<br />
            <span style={{ background: 'linear-gradient(135deg, #4ade80, #86efac)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Pet Instantly</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 justify-center mb-10" style={fadeIn(0.3)}>
            <Link to="/shop" className="px-8 py-3 rounded-xl font-bold text-black transition-all hover:scale-105 text-lg"
              style={{ background: 'linear-gradient(135deg, #4ade80, #22c55e)', boxShadow: '0 0 25px rgba(74,222,128,0.35)' }}>
              🛒 Shop All Now
            </Link>
            <Link to="/how-it-works" className="px-8 py-3 rounded-xl font-bold transition-all hover:scale-105 text-lg"
        ...
        <section className="px-4 md:px-8 pb-20 max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              { icon: '⏰', title: 'Guaranteed Within 24 Hours', desc: 'We deliver daily between 12PM - 2AM CST. Orders outside this window will be fulfilled the next delivery window!' },
              { icon: '🔒', title: 'Safe & Secure', desc: 'Secure Stripe payments and trusted by our growing community' },
            ].map((card, i) => (
              <div key={i} className="rounded-2xl p-7 text-center transition-all hover:scale-105 cursor-default"
                style={{ ...fadeIn(0.4 + i * 0.1), background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(74,222,128,0.1)' }}>
        ...
        {/* STATS */}
        <section className="px-4 md:px-8 pb-24 max-w-3xl mx-auto" style={{ borderTop: '1px solid rgba(74,222,128,0.08)', paddingTop: '3rem' }}>
        ...
        <section className="px-4 md:px-8 pb-24 max-w-3xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              ...
              <div key={i} className="rounded-2xl p-5" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(74,222,128,0.08)' }}>
          ...
          <Link to="/how-it-works" className="inline-block px-6 py-3 rounded-xl font-bold transition-all hover:scale-105"
        ...
        <section className="px-4 md:px-8 pb-24 max-w-4xl mx-auto">
          ...
          {reviews.length === 0 ? (
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 text-left">
                {reviews.map(review => (
                  <div key={review.id} className="rounded-2xl p-6" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(74,222,128,0.08)' }}>
              ...
              <div className="text-center">
                <Link to="/reviews" className="inline-block mb-10 px-8 py-3 rounded-xl font-bold transition-all hover:scale-105"
                  style={{ border: '1px solid rgba(74,222,128,0.3)', color: '#86efac', background: 'rgba(74,222,128,0.05)' }}>
                  See All Reviews
                </Link>
              </div>
          ...
          <div className="rounded-2xl p-6 md:p-8 text-left max-w-xl mx-auto" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(74,222,128,0.1)' }}>
            ...
            {submitted ? (
              <div className="text-center py-4">
                ...
                <p className="text-gray-500 text-sm mt-1">It will show up once approved</p>
              </div>
            ) : (
              <div className="flex flex-col gap-4">
                <div>
                  <label className="text-white font-bold text-sm block mb-2">Roblox Username</label>
                  <input type="text" placeholder="Your Roblox username..." value={username} onChange={e => setUsername(e.target.value)}
                    className="w-full text-white rounded-lg px-4 py-3 outline-none" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(74,222,128,0.2)' }} />
                </div>
                <div>
                  <label className="text-white font-bold text-sm block mb-2">Rating</label>
                  <div className="flex gap-2">
                    {[1,2,3,4,5].map(star => (
                      <button key={star} onClick={() => setRating(star)} className={`text-2xl transition ${star <= rating ? 'opacity-100' : 'opacity-30'}`}>⭐</button>
                    ))}
                  </div>
                </div>
                <div>
                  ...
                  <textarea placeholder="Tell us about your experience..." value={message} onChange={e => setMessage(e.target.value)} rows={3}
                    className="w-full text-white rounded-lg px-4 py-3 outline-none resize-none" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(74,222,128,0.2)' }} />
                </div>
                <button onClick={handleSubmit} className="w-full font-bold py-3 rounded-lg transition-all hover:scale-105 text-black"
        ...
        <section className="px-4 md:px-8 pb-24 max-w-2xl mx-auto text-center">
          <div className="rounded-2xl p-10" style={{ background: 'rgba(74,222,128,0.03)', border: '1px solid rgba(74,222,128,0.1)' }}>
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              ...
              <Link to="/socials" className="px-6 py-3 rounded-xl font-bold transition-all hover:scale-105"
                style={{ border: '1px solid rgba(74,222,128,0.3)', color: '#86efac', background: 'rgba(74,222,128,0.05)' }}>
                All Socials →
              </Link>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 md:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  <Link to="/shop" className="text-gray-500 hover:text-green-400 transition text-sm">All Items</Link>
                  <Link to="/shop?filter=Mega" className="text-gray-500 hover:text-green-400 transition text-sm">Mega Pets</Link>
                  <Link to="/shop?filter=Neon" className="text-gray-500 hover:text-green-400 transition text-sm">Neon Pets</Link>
                  <Link to="/shop?filter=Normal" className="text-gray-500 hover:text-green-400 transition text-sm">Normal Pets</Link>
                  <Link to="/shop?filter=Egg" className="text-gray-500 hover:text-green-400 transition text-sm">Eggs</Link>
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  <Link to="/how-it-works" className="text-gray-500 hover:text-green-400 transition text-sm">How It Works</Link>
                  <Link to="/reviews" className="text-gray-500 hover:text-green-400 transition text-sm">Reviews</Link>
                  <Link to="/about" className="text-gray-500 hover:text-green-400 transition text-sm">About Us</Link>
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  <Link to="/privacy-policy" className="text-gray-500 hover:text-green-400 transition text-sm">Privacy Policy</Link>
                  <Link to="/terms-of-service" className="text-gray-500 hover:text-green-400 transition text-sm">Terms of Service</Link>
                  <Link to="/refund-policy" className="text-gray-500 hover:text-green-400 transition text-sm">Refund Policy</Link>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center pt-6 gap-4" style={{ borderTop: '1px solid rgba(74,222,128,0.06)' }}>
              ...
              <div className="flex gap-4">
                <a href="https://discord.gg/yZHbUFTh" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-indigo-400 transition text-sm">💬 Discord</a>
                <a href="https://www.tiktok.com/@thepixelgrove" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-pink-400 transition text-sm">🎵 TikTok</a>
              </div>
            </div>
          </div>
        </footer>
